...
class EditClient extends Component implements HasForms
{
    ...
    {
        $this->client = Client::findByUuidOrFail($uuid);
        $client  = $this->client;
    ...
    public function update(): void
    {
        ...
        try {
            DB::beginTransaction();
            $client = (new ClientClass())->saveClient($data,$client_id);
            Notification::make()
    ...
    {
        return view('livewire.dashboard.clients.edit-client');
    }
}
